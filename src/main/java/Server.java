...
import collection.helpers.StackPersonStorage;
import collection.helpers.StackPersonStorageService;
import collection.helpers.Storage;
import collection.helpers.StorageService;
import commands.CommandsManager;
import commands.commands.AbstractCommand;
...
public class Server implements Runnable{
    ...
    public static void main(String[] args){
        args = new String[]{"C:/Users/isy02/Desktop/x.csv", ";"};
        try {
    ...
    public void run() {
        ...
        if (f != null){
            ...
            try {
                ...
                if (!success) {
                    userInterface.writeln("Вы работаете с пустой коллекцией." );
                }
            }
        }
